...
class Loan_item(models.Model):
    ...
    #loan_start_date = models.CharField(max_length=128, null=True)
    #loan_end_date = models.CharField(max_length=128, null=True)
...
class Loan(models.Model):
    ...
    #loan_accepted = models.CharField(max_length=3, null=False, default="No")
